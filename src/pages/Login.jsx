...
const DEMO = [
    { role: "Hospital Admin", email: "admin@cityhospital.com", password: "admin123" },
    { role: "Receptionist", email: "reception@cityhospital.com", password: "recep123" },
    { role: "Pharmacist", email: "pharmacy@cityhospital.com", password: "pharma123" },
    { role: "Doctor (Sharma)", email: "dr.sharma@cityhospital.com", password: "doctor123" },
    { role: "Doctor (Patel)", email: "dr.patel@cityhospital.com", password: "doctor123" },
        ...
        <div className="min-h-screen grid md:grid-cols-2 bg-[#F9F9F7]">
            <div className="hidden md:flex flex-col justify-between bg-[#2A4B41] text-white p-12 relative overflow-hidden">
                <Link to="/" className="flex items-center gap-2" data-testid="login-brand">
                    <div className="w-9 h-9 rounded-lg bg-white text-[#2A4B41] grid place-items-center font-heading font-black">Q</div>
                    <div className="font-heading font-black tracking-tight text-xl">QLess</div>
                </Link>
                <div>
                    <div className="text-[11px] tracking-[0.3em] uppercase text-white/60 font-bold">Queue OS</div>
                    ...
                    <p className="text-white/70 mt-6 max-w-md leading-relaxed">
                        Sign in to manage doctors, tokens and live queues across your hospital.
                    </p>
                </div>
            ...
            <div className="flex items-center justify-center p-6 md:p-12">
                <div className="w-full max-w-md">
                    <div className="text-xs tracking-[0.25em] uppercase font-bold text-[#5C6661]">Sign in</div>
                    <h2 className="font-heading text-3xl font-black tracking-tight mt-2">Welcome back.</h2>
                    <p className="text-sm text-[#5C6661] mt-2">Use your QLess staff credentials.</p>
                        ...
                        <div className="space-y-2">
                            {DEMO.map((d) => (
                                ...
                                >
                                    ...
                                    <div className="text-xs text-[#5C6661] font-mono mt-0.5">{d.email}</div>
                                </button>
                            ))}
                        </div>
                    </div> */}
